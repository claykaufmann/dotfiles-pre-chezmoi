...
This code block controls most of the changes when in zen mode. This is from [[https://github.com/tecosaur/emacs-config/blob/master/config.org][tecosaur again]], with this great hook on write-room mode. I modified it a bit to more fit my needs, of disabling hl-line-mode, not disabling org-indent, and setting visual line and variable pitch mode.
#+begin_src emacs-lisp
